...
import { dataSavingStep, imageEmotionDataSavingStep } from "../data";
...
export default function agneBergaWorkflow(timeline, jsPsych) {
  ...
  timeline.push(database_preparing(["visualSearch", "geneveEmotionWheel", "likertSurvey", "imageEmotionTask"]))

  introBerga(timeline, jsPsych)
  timeline.push(dataSavingStep(jsPsych, "participants"));

  imageEmotionClassier(timeline, jsPsych);
  timeline.push(imageEmotionDataSavingStep(jsPsych));
